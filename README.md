...
- 🔔 Реализация **уведомлений** о предложенном обмене навыками между пользователями.  

## 🛠️ Технологии

Проект реализован с использованием современных инструментов веб-разработк:
- TypeScript
- React
- Redux
- Storybook
...
- Я выполнял роль **Team Lead**: организовывал рабочие процессы, распределял задачи и контролировал качество кода.  
- Остальные участники команды внесли вклад в разработку функционала и дизайн.
